...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            #user_decay_file = cms.vstring('fragmentfile/tkeffwithDstar/data/All_Dstar_D0pi_D0kpipipi.dec'),
            user_decay_file = cms.vstring('Dstar_test/tkeffwithDstar/data/Dstar_VSSD0pi_Kpipipipi_v4.dec'),
...
Dfilter = cms.EDFilter("MCSingleParticleFilter",
    MaxEta = cms.untracked.vdouble(2.0, 2.0),
...
D0Daufilter = cms.EDFilter("PythiaDauVFilter",
    ...
    MaxEta = cms.untracked.vdouble(9999, 9999, 9999, 9999),
    MinEta = cms.untracked.vdouble(-9999, -9999, -9999, -9999),
    NumberDaughters = cms.untracked.int32(4),
)

ProductionFilterSequence = cms.Sequence(generator*Dfilter*DstarDaufilter)
