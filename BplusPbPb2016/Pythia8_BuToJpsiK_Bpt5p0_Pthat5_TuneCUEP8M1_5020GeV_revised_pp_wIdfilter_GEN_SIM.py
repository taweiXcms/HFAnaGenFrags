...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Pythia8_BuToJpsiK_Bpt0_Pthat5_TuneCUEP8M1_5020GeV_revised_pp_GEN_SIM_IDfilter_inevt5k.root'),
...
process.BJpsiDaufilter = cms.EDFilter("PythiaMomDauFilter",
    ...
    MaxEta = cms.untracked.double(100000.0),#2.5
    MinEta = cms.untracked.double(-100000.0),#-2.5
...
process.mumugenfilter = cms.EDFilter("MCParticlePairFilter",
    MaxEta = cms.untracked.vdouble(100000.0, 100000.0),#2.5,2.5
    MaxInvMass = cms.untracked.double(10000.0),#4.0
    MinEta = cms.untracked.vdouble(-100000.0, -100000.0),#-2.5,-2.5
