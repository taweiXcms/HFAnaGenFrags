...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_BdJpsiKstar_TuneZ2star_2760GeV_GENSIM.root'),
...
#                'MyB-'),
    ...
    filterEfficiency = cms.untracked.double(0.0003114),#27/30000 162/200000 8.2e-04 359/400000 328/400000
...
#    DaughterIDs = cms.untracked.vint32(-321, 211),###not work
#    DaughterIDs = cms.untracked.vint32(-211, 321),
#    DaughterIDs = cms.untracked.vint32(211, -321),###This  does not work.
    verbose = cms.untracked.int32(0),
    MinPt = cms.untracked.vdouble(0.0, 0.0),
    MaxEta = cms.untracked.vdouble(9999, 9999),
    MinEta = cms.untracked.vdouble(-9999, -9999),
